"""
Django settings for polished_butterfly_42042 project.
...
ROOT_URLCONF = 'polished_butterfly_42042.urls'
...
WSGI_APPLICATION = 'polished_butterfly_42042.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "polished_butterfly_42042 API",
    "DESCRIPTION": "API documentation for polished_butterfly_42042 App",
    "VERSION": "v1",
}
